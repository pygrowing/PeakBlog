            ...
            lang: {
                ...
                dialog: {
                    ...
                    file: {
                        ...
                        alt: "文件描述",
                        uploadButton: "本地上传",
                        imageURLEmpty: "错误：文件地址不能为空。",
                        uploadFileEmpty: "错误：上传的文件不能为空。",
                        formatNotAllowed: "错误：允许上传的文件格式有："
                    },
                    video: {
                        title: "添加视频",
                        url: "视频地址",
            ...
            state: {watching: !1, loaded: !1, preview: !1, fullscreen: !1}, init: function (i, o) {
                ...
                if (g = t.filterHTMLTags(g, a.htmlDecode), this.markdownTextarea.text(l), s.save(), a.saveHTMLToTextarea && this.htmlTextarea.text(g), a.watch || !a.watch && n.preview) {
                    ...
                    a.tex && (!t.kaTeXLoaded && a.autoLoadModules ? t.loadKaTeX(function () {
                        t.$katex = katex, t.kaTeXLoaded = !0, r.katexRender(), e.proxy(a.onchange, this)()
                    }) : (t.$katex = katex, this.katexRender())), (a.flowChart || a.sequenceDiagram) && (o = setTimeout(function () {
                        clearTimeout(o), r.flowChartAndSequenceDiagramRender(), e.proxy(a.onchange, this)(), o = null
